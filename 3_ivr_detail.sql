...
LEFT JOIN `keepcoding.ivr_modules` AS ivr_modules
ON ivr_calls.ivr_id = ivr_modules.ivr_id
LEFT JOIN `keepcoding.ivr_steps` AS ivr_steps
ON ivr_steps.ivr_id = ivr_modules.ivr_id AND ivr_steps.module_sequece = ivr_modules.module_sequece
